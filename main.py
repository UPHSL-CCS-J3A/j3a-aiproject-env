...
def run_posture_detection():
    global ref_values, prev_status, stable_status, statuschange_starttime, settings
    ...
    while True:
        ...
        if res.pose_landmarks:
            ...
            if ref_values["calibrated"]:
                ...
                scale_factor = shoulder_y / ref_values["ref_shoulder_y"]
                dist_diff = nose_shoulder_dist - ref_values["ref_nose_shoulder_dist"] * scale_factor
                nose_depth_diff = nose.z - ref_values["ref_nose_z"]
